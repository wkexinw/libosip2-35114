...
pkglibexecdir = $(libexecdir)/libosip2
...
am__aclocal_m4_deps = $(top_srcdir)/scripts/ax_pthread.m4 \
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/libosip2.pc.in \
	$(srcdir)/osip-config.h.in $(top_srcdir)/scripts/compile \
	...
	$(top_srcdir)/scripts/mkinstalldirs AUTHORS COPYING ChangeLog \
...
ACLOCAL = ${SHELL} '/media/kevin/9A3AC50E3AC4E879/GIT/libosip2-5.3.0/scripts/missing' aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AUTOCONF = ${SHELL} '/media/kevin/9A3AC50E3AC4E879/GIT/libosip2-5.3.0/scripts/missing' autoconf
AUTOHEADER = ${SHELL} '/media/kevin/9A3AC50E3AC4E879/GIT/libosip2-5.3.0/scripts/missing' autoheader
AUTOMAKE = ${SHELL} '/media/kevin/9A3AC50E3AC4E879/GIT/libosip2-5.3.0/scripts/missing' automake-1.16
AWK = mawk
CC = gcc
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} '/media/kevin/9A3AC50E3AC4E879/GIT/libosip2-5.3.0/scripts/missing' makeinfo
MANIFEST_TOOL = :
...
SHELL = /bin/bash
SIP_CFLAGS = 
SIP_EXTRA_FLAGS =  -DENABLE_TRACE
SIP_FSM_FLAGS = 
SIP_PARSER_FLAGS = 
STRIP = strip
VERSION = 5.3.0
abs_builddir = /media/kevin/9A3AC50E3AC4E879/GIT/libosip2-5.3.0
abs_srcdir = /media/kevin/9A3AC50E3AC4E879/GIT/libosip2-5.3.0
abs_top_builddir = /media/kevin/9A3AC50E3AC4E879/GIT/libosip2-5.3.0
abs_top_srcdir = /media/kevin/9A3AC50E3AC4E879/GIT/libosip2-5.3.0
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /media/kevin/9A3AC50E3AC4E879/GIT/libosip2-5.3.0/scripts/install-sh
...
pdfdir = ${docdir}
prefix = /home/kevin/workspace/3rd/osip2
...
osip-config.h: stamp-h1
	@test -f $@ || rm -f stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) stamp-h1

stamp-h1: $(srcdir)/osip-config.h.in $(top_builddir)/config.status
	@rm -f stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status osip-config.h
$(srcdir)/osip-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f stamp-h1
	touch $@

distclean-hdr:
	-rm -f osip-config.h stamp-h1
...
all-am: Makefile $(DATA) osip-config.h
